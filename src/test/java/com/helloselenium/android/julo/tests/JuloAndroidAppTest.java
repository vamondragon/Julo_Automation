...
public class JuloAndroidAppTest extends AbstractBaseTest {
	...
	public void uploadDocuments() {
		...
		// ProfileScreen.fillLoanDetails(TestData.INSTANCE.get("loanInterest"),
		// TestData.INSTANCE.get("loanDesc"),
		// TestData.INSTANCE.get("aboutJulo"),
		// TestData.INSTANCE.get("referralCode"),
		// TestData.INSTANCE.get("personalPhone"));
		// ProfileScreen.clickPersonalDataOption();
		// ProfileScreen.fillPersonalData(TestData.INSTANCE.get("name"),
		// ElementLocators.INSTANCE.get("dobDate"),
		// TestData.INSTANCE.get("gender"), TestData.INSTANCE.get("ktp"),
		// TestData.INSTANCE.get("address"),
		// ElementLocators.INSTANCE.get("durationDate"),
		// TestData.INSTANCE.get("domicile2"),
		// TestData.INSTANCE.get("phone1"),
		// TestData.INSTANCE.get("civilStatus"),
		// Integer.parseInt(TestData.INSTANCE.get("dependents")));
		// ProfileScreen.clickFamilyInfoOption();
		// ProfileScreen.fillFamilyInfo(TestData.INSTANCE.get("name2"),
		// TestData.INSTANCE.get("phone"),
		...
		// ProfileScreen.fillFormFinancial(TestData.INSTANCE.get("installment"),
		// TestData.INSTANCE.get("expenses"),
		// TestData.INSTANCE.get("liabilities"),
		// TestData.INSTANCE.get("branch"),
		...
		ProfileScreen.saveResidencial(false);
		ProfileScreen.clickFinancialOption();
		ProfileScreen.saveFinancial();
		ProfileScreen.clickSmileTakeSelfieOption();
		ProfileScreen.saveSelfie();
		ProfileScreen.clickUploadDocumentsButton();
		quitAndroidDriver();
	}
}
