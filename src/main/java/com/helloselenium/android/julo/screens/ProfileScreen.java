...
public class ProfileScreen {
	...
	public static void saveResidencial(boolean emulator) {
		...
		By saveResidencialButton = MobileBy.AndroidUIAutomator(ElementLocators.INSTANCE.get("saveResidencialButton"));
		wait.until(ExpectedConditions.visibilityOf(mobileDriver.findElement(saveResidencialButton)));
		AndroidActions.click(mobileDriver.findElement(saveResidencialButton));
	}
